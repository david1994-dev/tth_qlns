                    ...
                    <div class="row">
                        ...
                        <div class="col-md-10">
                            ...
                            <div>
                                ...
                                Chuyên khoa II
                                <input type="checkbox" name="hinh_thuc_dao_tao[]" value="Du học nước ngoài"> e. Du
                                học
                                nước
                                ngoài
                            ...
                            <div>
                                <input type="checkbox" name="ung_tuyen[]" value="Nội tổng hợp"> <label
                                    for="Nội tổng hợp">Nội tổng hợp</label>
                            ...
                            <div>
                                ...
                                <label for="Giải phẫu">Giải phẫu</label>
                            </div>
                            <div>
                                <input type="checkbox" name="ung_tuyen[]" value="Phẫu thuật thẩm mỹ">
                                <label for="Phẫu thuật thẩm mỹ">Phẫu thuật tạo hình thẩm mỹ</label>
