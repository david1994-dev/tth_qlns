            ...
            <div class="container">
                ...
                <div style="margin-left: 220px;">
                    ...
                    <div style="text-align: right; display: inline;">
                        ...
                        <p style="display: inline;">Tháng</p><input type="number" class="input" style="width: 5%;"
                            name="thang_sinh" placeholder="........">
                        <p style="display: inline;">Năm</p><input type="number" class="input" style="width: 10%;"
                            name="nam_sinh" placeholder=".............">
                    </div> <br>

                    <p style="display: inline;">Chuyên ngành đào tạo:</p> <input class="input" style="width: 30%;"
                        name="chuyen_nganh_dao_tao"
                        placeholder="......................................................................"> Hệ đào
                    tạo:
                    <input class="input" name="he_dao_tao" style=" width: 10%px;"
                        placeholder="..................................."><br>
                    <p style="display: inline;">Địa chỉ:</p> <input class="input" style=" width: 60%;" name="dia_chi"
                        placeholder="......................................................................................................................................................................"><br>
                ...
                <table class="table table-bordered" style="width: 50%; margin-left: 180px">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        <tr>
                            <td style="width: 100%; height: 100%; "><input name="thoi_gian_lam_viec[]"
                                    class="input">
                            </td>
                ...
                <p style="margin-left: 180px;font-weight: 600; display: inline;"> 2.Anh(chị) tự đánh giá trình độ
                    chuyên
                    môn
                    của anh chị(chuyên nghành chính giỏi nhất)</p><br>
                <input type="radio" name="trinh_do" value="gioi" style="margin-left: 180px;"> Giỏi( thực hiện
                được
                100% kỹ
                ...
                <input type="radio" name="trinh_do" value="kha" style="margin-left: 180px;"> Khá( thực hiện
                được
                90% kỹ
                thuật tuyến <p style="font-weight: 600; display: inline;">Tỉnh</p> trở xuống,70% kỹ thuật tuyến <p
                    style="font-weight: 600; display: inline;">Trung ương</p>)<br>
                <input type="radio" name="trinh_do" value="trung_binh" style="margin-left: 180px;"> Trung Bình(
                thực
                hiện
                ...
                <textarea class="form-control" aria-label="With textarea" style="margin-left: 180px;width: 75%;" name="ky_nang_khac"></textarea>
                {{-- <textarea style="margin-left: 180px; width: 800px; height: 100px;" cols="30" rows="10"
                    name="ky_nang_khac"></textarea> <br> <br> --}}
                <p style="margin-left: 180px;font-weight: 600; display: inline;"> 3.Anh(chị) có nhu cầu để tiếp tục học
                    các
                ...
                <div>
                    <input type="checkbox" name="hinh_thuc_dao_tao[]" value="Thạc sĩ" style="margin-left: 180px;">
                    a.
                    Thạc sỹ
                ...
                <div>
                    ...
                    nước
                    ngoài
                    <input type="checkbox" name="hinh_thuc_dao_tao[]" value="khác" style="margin-left: 50px;"> f.
                    Khác
                </div> <br>
                <p style="margin-left: 180px;font-weight: 600; display: inline;"> 4. Anh (chị) mong muốn thời hạn ký
                    kết
                    hợp đồng như thế nào nếu được tuyển dụng vào làm việc tại Công ty?</p><br>
                <div>
                    <input type="radio" name="thoi_han_hop_dong" value="7 Năm" style="margin-left: 180px;"> a. 7
                    năm
                    <input type="radio" name="thoi_han_hop_dong" value="15 Năm" style="margin-left: 180px;"> c. 15
                    năm
                    <input type="radio" name="thoi_han_hop_dong" value="20 Năm" style="margin-left: 180px;"> e. 20
                    năm
                    <input type="radio" name="thoi_han_hop_dong" value="30 Năm" style="margin-left: 180px;"> g. 30
                    năm
                </div>
                <div>
                    <input type="radio" name="thoi_han_hop_dong" value="12 Năm" style="margin-left: 180px;"> b. 12
                    năm
                    <input type="radio" name="thoi_han_hop_dong" value="17 Năm" style="margin-left: 170px;"> d. 17
                    năm
                    <input type="radio" name="thoi_han_hop_dong" value="25 Năm" style="margin-left: 178px;"> f. 25
                    năm
                    <input type="radio" name="thoi_han_hop_dong" value="khác" style="margin-left: 184px;"> h.
                    Khác
                </div> <br>
                <p style="margin-left: 180px;font-weight: 600; display: inline;"> 5.Anh(chị) có nguyện vọng làm việc
                    vào vị
                ...
                <div>
                    <input type="checkbox" name="ung_tuyen[]" value="Nội tổng hợp"style="margin-left: 180px;"> Nội
                    tổng
                    hợp
                ...
                <div>
                    <input type="checkbox" name="ung_tuyen[]" value="Nội tim mạch" style="margin-left: 180px;"> Nội
                    tim
                    mạch
                ...
                <div>
                    ...
                    <input type="checkbox" name="ung_tuyen[]" value="Y học cổ truyền" style="margin-left: 8px;"> Y
                    học
                    cổ truyền
                    <input type="checkbox" name="ung_tuyen[]" value="Giải phẫu" style="margin-left: 93px;"> Giải
                    phẫu
                    bệnh
                </div>
                <div>
                    ...
                    Phẫu thuật tạo
                    hình thẩm mỹ
                    <input type="checkbox" name="ung_tuyen[]" value="Răng hàm mặt" style="margin-left: 2px;"> Răng
                    hàm
                    mặt
                ...
                <div>
                    ...
                    <input type="checkbox" name="ung_tuyen[]" value="Tai mũi họng" style="margin-left: 158px;"> Tai
                    mũi
                    họng
                ...
                <div>
                    <input type="checkbox" name="ung_tuyen[]" value="Bệnh nhiệt đới" style="margin-left: 180px;">
                    Bệnh
                    nhiệt
                    đới(truyền nhiễm)
                    <input type="checkbox" name="ung_tuyen[]" value="Mắt" style="margin-left: 1px;"> Mắt
                    <input type="checkbox" name="ung_tuyen[]" value="Dinh dưỡng" style="margin-left: 151px;"> Dinh
                    dưỡng
                ...
                <p style="margin-left: 180px;font-weight: 600; display: inline;"> 6.Anh(chị) mong muốn công tác tại
                    bệnh
                ...
                <p style="margin-left: 180px;font-weight: 600; display: inline;"> 7.Anh(chị) biết thông tin tuyển dụng
                    của
                ...
                <p style="margin-left: 180px;font-weight: 600; display: inline;"> 10.Mức lương mong muốn của anh(chị)
                    khi
                    vào làm việc tại công ty?</p><br>
                <textarea style="margin-left: 180px; width: 800px; height: 100px;" cols="30" rows="10"
                    name="luong_mong_muon"></textarea> <br> <br>
                <p style="margin-left: 180px;font-weight: 600; display: inline;"> 11.Anh(chị) có kiến nghị, đề xuất
                    hoặc
