            ...
            <form class="w-75 border border-2 border-success p-5 rounded" style="margin: auto;">
                ...
                <div style="margin-left: 220px;">
                    ...
                    <p style="display: inline;">Điện thoại:</p> <input class="input" style="width: 300px;"
                        ...
                        class="input" style=" width: 232px;" type="email"
                        placeholder="................................................................."><br>
                ...
                <p style="margin-left: 180px;font-weight: 600; display: inline;"> 2.Anh(chị) có khả năng(Thời gian, kinh
                    tế,
                ...
                <div>
                    <input type="checkbox" name="ung_tuyen[]" value="Nhân viên kinh doanh" style="margin-left: 180px;"> Nhân viên kinh doanh
                    <input type="checkbox" name="ung_tuyen[]" value="NV Thiết kế" style="margin-left: 35px;"> NV Thiết kế
                    <input type="checkbox" name="ung_tuyen[]" value="Nhân viên truyền thông" style="margin-left: 50px;"> Nhân viên truyền thông
                </div>
                <div>
                    <input type="checkbox" name="ung_tuyen[]" value="Nhân viên hành chính" style="margin-left: 180px;"> Nhân viên hành chính
                    <input type="checkbox" name="ung_tuyen[]" value="Nhân viên CSKH" style="margin-left: 36px;"> Nhân viên CSKH
                    <input type="checkbox" name="ung_tuyen[]" value="Nhân viên quản trị web" style="margin-left: 17px;"> Nhân viên quản trị web
                </div>
                <div>
                    <input type="checkbox" name="ung_tuyen[]" value="NV Tư vấn PTTM" style="margin-left: 180px;"> NV Tư vấn PTTM
                    <input type="checkbox" name="ung_tuyen[]" value="CV Nhân sự" style="margin-left: 72px;"> CV Nhân sự
                    <input type="checkbox" name="ung_tuyen[]" value="NV Điện nước" style="margin-left: 50px;"> NV Điện nước
                </div>
                <div>
                    <input type="checkbox" name="ung_tuyen[]" value="NV Thu ngân - Lễ tân" style="margin-left: 180px;"> NV Thu ngân - Lễ tân
                    <input type="checkbox" name="ung_tuyen[]" value="NV Văn thư" style="margin-left: 39px;"> NV Văn thư
                    <input type="checkbox" name="ung_tuyen[]" value="NV Kế hoạch" style="margin-left: 53px;"> NV Kế hoạch
                </div>
                <div>
                    <input type="checkbox" name="ung_tuyen[]" value="NV Kế toán" style="margin-left: 180px;"> NV Kế toán
                    <input type="checkbox" name="ung_tuyen[]" value="NV Lái xe" style="margin-left: 110px;"> NV Lái xe
                    <input type="checkbox" name="ung_tuyen[]" value="NV Thiết kế phần" style="margin-left: 67px;"> NV Thiết kế phần
                    mềm
                </div>
                <div>
                    <input type="checkbox" name="ung_tuyen[]" value="NV Pháp chế" style="margin-left: 180px;"> NV Pháp chế
                    <input type="checkbox" name="ung_tuyen[]" value="NV Bảo vệ" style="margin-left: 99px;"> NV Bảo vệ
                    <input type="checkbox" name="ung_tuyen[]" value="NV Quản lý dự án" style="margin-left: 61px;"> NV Quản lý dự án
                </div>
                <div>
                    ...
                    <input type="checkbox" name="ung_tuyen[]" value="NV Đối ngoại và quan hệ QT" style="margin-left: 95px;"> NV Đối ngoại và quan hệ QT
                </div>
