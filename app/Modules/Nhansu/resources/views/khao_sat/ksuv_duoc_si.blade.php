                ...
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-10">
                            ...
                            <div>
                                <div>
                                    <input type="checkbox" name="ung_tuyen[]" value="Nội khoa" max="3">Nội khoa
                                    <input type="checkbox" name="ung_tuyen[]" value="Sản phụ khoa" max="3" style="margin-left: 7%">
                                    Sản
                                    phụ khoa
                                    <input type="checkbox" name="ung_tuyen[]" value="Xét nghiệm" max="3" style="margin-left: 8%"> Xét
                                    nghiệm
                                    <input type="checkbox" name="ung_tuyen[]" value="Răng hàm mặt" max="3" style="margin-left: 17%">
                                    Răng
                                    hàm mặt
                                </div>
                                <div>
                                    ...
                                    Ngoại
                                    khoa
                                    <input type="checkbox" name="ung_tuyen[]" value="Nhi khoa" max="3" style="margin-left: 4.6%">
                                    Nhi khoa
                                    <input type="checkbox" name="ung_tuyen[]" value="Chẩn đoán hình ảnh- thăm dò CN" style="margin-left: 11.6%"
                                ...
                                <div>
                                    ...
                                    <input type="checkbox" name="ung_tuyen[]" value="dinh dưỡng" max="3" style="margin-left: 1%">
                                    dinh
                                    dưỡng
                                    <input type="checkbox" name="ung_tuyen[]" value="Chuyên viên kế hoạch tổng hợp" style="margin-left: 16.7%"
                                        max="3"> Chuyên viên kế hoạch tổng hợp
                                </div>
                                <div>
                                    <input type="checkbox" name="ung_tuyen[]" value="YHCT" max="3">
                                    YHCT
                                    <input type="checkbox" name="ung_tuyen[]" value="Hồi sức cấp cứu" style="margin-left: 9.2%"
                                        max="3">
                                    Hồi sức cấp cứu
                                    <input type="checkbox" name="ung_tuyen[]" value="Thẩm mỹ - da liễu" style="margin-left: 6.4%"
                                        max="3">
                                    Thẩm mỹ - da liễu
                                    <input type="checkbox" name="ung_tuyen[]" value="Gây mê - Phẫu thuật" style="margin-left: 12%"
                            ...
                            <div>
                                ...
                                <input type="checkbox" name="thong_tin_tuyen_dung[]" value="Facebook" style="margin-left: 5%"> Facebook
                                <input type="checkbox" name="thong_tin_tuyen_dung[]" value="Báo chí/ Truyền hình" style="margin-left: 7%">
                                Báo
                                chí/ Truyền hình
                            </div>
                            <div>
                                ...
                                Web/fanpage Công ty
                                <input type="checkbox" name="thong_tin_tuyen_dung[]" value="Vietnamwork" style="margin-left: 4.5%"> Vietnamwork
                                <input type="checkbox" name="thong_tin_tuyen_dung[]" value="Nguồn khác" style="margin-left: 4.3%"> Nguồn khác
                            </div> <br>
