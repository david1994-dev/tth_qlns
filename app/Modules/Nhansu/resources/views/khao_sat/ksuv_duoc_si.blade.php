                ...
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-10">
                            ...
                            <div class="row">
                                <div class="col-3">
                                    <input type="checkbox" name="ung_tuyen[]" value="Nội khoa" max="3">Nội
                                    khoa <br>
                                ...
                                <div class="col-3">
                                    ...
                                    <input type="checkbox" name="ung_tuyen[]" value="Chẩn đoán hình ảnh- thăm dò CN"
                                        max="3"> Chẩn đoán hình ảnh- thăm dò CN <br>
                                ...
                                <div class="col-3">
                                    ...
                                    <input type="checkbox" name="ung_tuyen[]" value="U bước-Y học hạt nhân"
                                        max="3"> U bước-Y học hạt nhân <br>
                                    ...
                                    <input type="checkbox" name="ung_tuyen[]" value="Chuyên viên kế hoạch tổng hợp"
                                        max="3"> Chuyên viên kế hoạch tổng hợp <br>
                                </div>
                                <div class="col-3">
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <input type="checkbox" name="don_vi_ung_tuyen[]"
                                        value="BV RHM và PTTHTM Thái Thượng Hoàng"> BV RHM và PTTHTM Thái
                                    Thượng Hoàng <br>
                                    <input type="checkbox" name="don_vi_ung_tuyen[]"
                                    ...
                                    Bệnh viện Đa khoa TTH Vinh <br>
                                    <input type="checkbox" name="don_vi_ung_tuyen[]"
                                        value="Bệnh viện Đa khoa TTH Quảng Bình">
                                    Bệnh viện Đa khoa TTH Quảng Bình <br>
                                </div>
                                <div class="col-6">
                                    <input type="checkbox" name="don_vi_ung_tuyen[]"
                                    ...
                                    Bệnh viện Đa khoa TTH Hà Tĩnh <br>
                                </div>
                            </div> <br>
