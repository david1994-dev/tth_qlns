            ...
            <form id="ksDSForm" action="{{ route('nhansu.taoUngVien') }}" method="post"
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-9 ">
                            <div style="text-align: right;"><i>Ngày</i><input type="number" class="input" value="{{old('ngay_khao_sat') ?? ''}}"
                                    name="ngay_khao_sat" style="width: 5%;" placeholder="...."><i>Tháng</i><input
                                    type="number" class="input" name="thang_khao_sat" style="width: 5%;" value="{{old('thang_khao_sat') ?? ''}}"
                                    placeholder="...."><i>Năm</i><input type="number" class="input" value="{{old('nam_khao_sat') ?? ''}}"
                            ...
                            <p style="font-weight: 600;"> Vị trí ứng tuyển: <input class="input" value="{{old('vi_tri_ung_tuyen') ?? ''}}"
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-10">
                            ...
                            <input type="radio" name="hoc_lop_nang_cao" value="Có"
                            > a.
                            Có
