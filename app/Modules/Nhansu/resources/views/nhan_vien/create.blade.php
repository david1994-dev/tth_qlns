...
@section('content')
    <div class="card p-3">
        ...
        <form class="d-flex flex-column row-gap-3">
            <div class="row gx-5 d-flex flex-column flex-md-row justify-content-between row-gap-3">
                <div class="col-2">
                ...
                <div class="col-12 col-md-4 d-flex flex-column row-gap-3">
                    <div class="form-group row">
                        <label for="staticEmail" class="col-sm-3 col-form-label">Ho ten</label>
                        <div class="col-sm-9">
                    ...
                    <div class="form-group row">
                        <label for="staticEmail" class="col-sm-3 col-form-label">Dien thoai</label>
                        <div class="col-sm-9">
                            <div class="input-group">
                                <input type="text" class="form-control" />
                                <div class="input-group-append">
                                    <span class="input-group-text" id="basic-addon2"><i class="ri-phone-line"></i></span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-12 col-md-4 d-flex flex-column row-gap-3">
                    <div class="form-group row">
                        <label for="staticEmail" class="col-sm-3 col-form-label">Chi nhanh</label>
                        <div class="col-sm-9">
                    ...
                    <div class="form-group row">
                        <label for="staticEmail" class="col-sm-3 col-form-label">Phong ban</label>
                        <div class="col-sm-9">
                            <select name="" id="" class="form-control select2">
                                <option value="Kinh"></option>
                            </select>
                    ...
                    <div class="form-group row">
                        <label for="staticEmail" class="col-sm-3 col-form-label">Phong ban them</label>
                        <div class="col-sm-9">
                            <select name="" id="" class="form-control select2">
                                <option value="kinh"></option>
                            </select>
                    ...
                    <div class="form-group row">
                        <label for="staticEmail" class="col-sm-3 col-form-label">Vi tri Cong viec</label>
                        <div class="col-sm-9">
                            <select name="" id="" class="form-control select2">
                                <option value="Nhan vien trien khai"></option>
                            </select>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col">
                    <label for="">Loai ho so*:</label>
                    <select name="" id="" class="form-control"></select>
                </div>
                <div class="col">
                    <label for="">Gioi tinhh*:</label>
                    <select name="" id="" class="form-control"></select>
                </div>
                <div class="col">
            ...
            <div class="row">
                <div class="col-6">
                    <label for="">Que quan*:</label>
                    <div class="input-group mb-3">
                        <input type="text" class="form-control" />
                        <div class="input-group-append">
                            <span class="input-group-text" id="basic-addon2"><i class="ri-home-2-line"></i></span>
                        </div>
                    </div>
                </div>
                <div class="col-6">
                    <div class="row">
                        <div class="col">
                            <label for="">Dan toc*:</label>
                            <select name="" id="" class="form-control">
                                <option value="">Demo</option>
                            </select>
                        </div>
                        <div class="col">
                            <label for="">Ton giao*:</label>
                            <div class="input-group mb-3">
                                <input type="text" class="form-control" />
                                <div class="input-group-append">
                                        <span class="input-group-text" id="basic-addon2"><i
                                                class="ri-contacts-book-2-fill"></i></span>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col">
                    <label for="">Dia chi thuong tru*:</label>
                    <div class="input-group mb-3">
                        <input type="text" class="form-control" />
                        <div class="input-group-append">
                            <span class="input-group-text" id="basic-addon2"><i class="ri-home-2-fill"></i></span>
                        </div>
                    </div>
                </div>
                <div class="col">
                    <label for="">Dia chi tam tru*:</label>
                    <div class="input-group mb-3">
                        <input type="text" class="form-control" />
                        <div class="input-group-append">
                            <span class="input-group-text" id="basic-addon2"><i class="ri-home-2-line"></i></span>
            ...
            <div class="row">
                <div class="col">
                    <label for="">Ma so thue*:</label>
                    <div class="input-group mb-3">
                        <input type="text" class="form-control" />
                        <div class="input-group-append">
                            <span class="input-group-text" id="basic-addon2"><i class="ri-barcode-fill"></i></span>
                        </div>
                    </div>
                </div>
                <div class="col">
                    <label for="">Dien thoai cong viec*:</label>
                    <div class="input-group mb-3">
                        <input type="text" class="form-control" />
                        <div class="input-group-append">
                            <span class="input-group-text" id="basic-addon2"><i class="ri-phone-line"></i></span>
                ...
                <div class="col">
                    <label for="">Email phu*:</label>
                    <div class="input-group mb-3">
                        <input type="text" class="form-control" />
                        <div class="input-group-append">
                            <span class="input-group-text" id="basic-addon2"><i class="ri-mail-line"></i></span>
                        </div>
                    </div>
                </div>
            </div>
            <div class="row mb-3">
                <div class="col">
                    <label for="">Ngay bat dau lam viec*:</label>
                    <input type="date" class="form-control" />
                </div>
                <div class="col">
                    <label for="">Ngay ket thuc lam viec*:</label>
                    <input type="date" class="form-control" />
                </div>
                <div class="col">
                    <label for="">Ngay thuc te lam viec*:</label>
                    <input type="date" class="form-control" />
                </div>
            </div>
            <div class="row">
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <div class="input-group-append">
                                        <span class="input-group-text" id="basic-addon2"><i
                                                class="ri-id-card-line"></i></i></span>
                                </div>
                            </div>
                        </div>
                        <div class="col">
                            <label for="">Ngay cap*:</label>
                            <input type="date" class="form-control" />
                        </div>
                    </div>
                </div>
                <div class="col">
                    <label for="">Noi cap*:</label>
                    <div class="input-group mb-3">
                        <input type="text" class="form-control" />
                        <div class="input-group-append">
                                <span class="input-group-text" id="basic-addon2"><i
                                        class="ri-map-pin-line"></i></i></span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-6">
                    <div class="row">
                        <div class="col">
                            <label for="">Trinh do chuyen mon:</label>
                            <select name="" id="" class="form-control"></select>
                        </div>
                        <div class="col">
                            <label for="">So CCHN*:</label>
                            <div class="input-group mb-3">
                                <input type="text" class="form-control" />
                                <div class="input-group-append">
                                        <span class="input-group-text" id="basic-addon2"><i
                                                class="ri-qr-scan-line"></i></i></span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col">
                    <label for="">Bo sung pham vi HDCM*:</label>
                    <div class="input-group mb-3">
                        <input type="text" class="form-control" />
                        <div class="input-group-append">
                                <span class="input-group-text" id="basic-addon2"><i
                                        class="ri-map-2-line"></i></i></span>
                        </div>
                    </div>
                </div>
            </div>
